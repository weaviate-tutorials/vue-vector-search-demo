...
const collectionName = ref("RSSGoo");
...
async function nearTextQuery() {
  ...
  const res = await client.graphql
    .get()
    .withClassName(collectionName.value)
  ...
  results.value = res.data.Get.RSSGoo;
  loading.value = false;
  return res;
}
  ...
  <main>
    ...
    <div class="items-center pb-6 pt-10 p-8">
      ...
      <div class="items-center flex justify-center">
        <p class="text-center text-m">
          Search the Rolling Stones 500 Top Songs of the last century with Keyword Search.
        </p>
    ...
    <div class="justify-center items-center">
      <div class="flex items-center justify-center pt-3">
        ...
        <input v-model="searchQuery" type="text" id="Search" placeholder="what are you looking for?"
      ...
      <p class="item-center flex justify-center text-xs text-gray-600 pt-2 pb-4">
          try and search for "songs about love"
        </p>
